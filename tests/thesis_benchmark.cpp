  ...
  if (data_type == "float") {
    ...
    switch (exp_type) {
      ...
      case 9:
        ...
        break;
      case 10:
        run_dispersion_evolution_experiment(*index, (float*)nullptr, 0, query_dim, query_f, query_num, query_dim,
    ...
    switch (exp_type) {
      ...
      case 9:
        ...
        break;
      case 10:
        run_dispersion_evolution_experiment(*index, (uint8_t*)nullptr, 0, query_dim, query_u8, query_num, query_dim,
                                            recall_at, mem_L, 50, beam_width, output_file);
        break;
      case 11:
